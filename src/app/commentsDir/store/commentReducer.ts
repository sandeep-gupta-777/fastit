...
export interface State {
    // comments: Array<{id?:string, commentData?:CommentData[]}>
  /*todo: remove redundant comment key...read about map interfaces in TS*/

  /**
   * post_comments_index_map: post_id is mapped to an array which will have all comments id.
   ...
   * {post_id:p1, {comment_id:c3, commentData:{...}}}
   * */
  ...
  switch (action.type){
    ...
    case fromCommentActions.GET_COMMENTS:{
      ...
      let additonalCommentsDataMap:Map<string, CommentData>=
        /*creates a mapping of commend id and commentData*/
      ...
      /*
      * 1. replace comment index array for the give post id with the new one
      ...
      * */
      ...
      return {
        ...
        // post_comments_index_map:tempPayload.comment_index_arr,
